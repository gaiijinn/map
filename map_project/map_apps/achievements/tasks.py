...
def check_achievements_status(obj_id):
    ...
    if obj:
        with transaction.atomic():
            ...
            # set user level
            # в будущем надо оставить условие потому что достижения нету смысла скидывать назад постоянно и проверять что если ласт уровень то перерасчет вообще не начинать
            # if is_achieved:
