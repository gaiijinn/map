...
def handler_success_request_for_achievement_update(status_code=status.HTTP_200_OK,
    ...
    def decorator(func):
        ...
        def wrapper(self, request, *args, **kwargs):
            ...
            if response.status_code == status_code and achievement_keyword is not None and update_func:
