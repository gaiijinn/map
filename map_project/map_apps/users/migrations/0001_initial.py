    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.BooleanField(
                        db_index=True,
                        default=False,
                        verbose_name="Зареєстрований як організація",
                    ),
                ),
                (
                    "is_verif",
                    models.BooleanField(default=False, verbose_name="Верифікований"),
                ),
                (
                    "rating",
                    models.PositiveSmallIntegerField(
                        blank=True, default=0, verbose_name="Рейтинг"
                    ),
                ),
                (
                    "groups",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("expired_at", models.DateTimeField(verbose_name="Дійсний до")),
                ("verif_to", models.DateTimeField(verbose_name="Активовано до")),
                (
                    "user",
                    models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "about_me",
                    models.CharField(
                        blank=True, max_length=512, null=True, verbose_name="Про себе"
                    ),
                ),
                (
                    "inst_link",
                    models.URLField(
                        ...
                        max_length=256,
                        null=True,
                        verbose_name="Instagram посилання",
                    ),
                ),
                (
                    "want_newsletters",
                    models.BooleanField(
                        default=False, verbose_name="Згоден отримувати новини"
                    ),
                ),
                (
                    "user",
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        related_name="userprofile",
                        to="users.userlevel",
                        verbose_name="Рівень користувача",
                    ),
                ),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "profile_picture",
                    models.TextField(
                        blank=True, max_length=100, verbose_name="Фото користувача"
                    ),
                ),
                (
                    "about_me",
