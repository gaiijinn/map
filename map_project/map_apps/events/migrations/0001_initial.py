    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creator', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='created_events', to=settings.AUTH_USER_MODEL, verbose_name='Власник')),
                ('event_guests', models.ManyToManyField(through='events.EventGuests', to=settings.AUTH_USER_MODEL)),
                ('event_reports', models.ManyToManyField(through='events.EventReports', to='events.EventReportTypes')),
            ],
        ),
        migrations.CreateModel(
            name='EventType',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('event', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='eventtypes', to='events.events')),
